...
namespace CakeMod
{
	...
	internal class Robohead : GunVolleyModificationItem
	{
		// Token: 0x0600008B RID: 139 RVA: 0x00005B8C File Offset: 0x00003D8C
		public static void Init()
		{
			string name = "Robohead";
			string resourcePath = "CakeMod/Resources/Robohead";
			GameObject gameObject = new GameObject(name);
			Robohead catSnack = gameObject.AddComponent<Robohead>();
			ItemBuilder.AddSpriteToObject(name, resourcePath, gameObject);
			string shortDesc = "BEEP BOOP, I AM A ROBOT";
			string longDesc = "Electricity sparks from the machine. It seems to be running Winbows.\n\n...Beep. Boop.";
		...
		private void PostProcessProjectile(Projectile projectile, float Chance)
		{
			...
			bool flag4 = flag3 && !Robohead.CoolAsIce;
			if (flag4)
			{
				Robohead.CoolAsIce = true;
				base.StartCoroutine(this.StartCooldown());
				float num = 0.97f - statValue / 50f;
				bool flag5 = UnityEngine.Random.value > num;
				bool flag6 = flag5 && !Robohead.SharkMFs;
				if (flag6)
				{
					Robohead.SharkMFs = true;
					base.StartCoroutine(this.SharkCooldown());
					Projectile projectile2 = ((Gun)ETGMod.Databases.Items[153]).DefaultModule.chargeProjectiles[0].Projectile;
