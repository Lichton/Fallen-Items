...
namespace CakeMod
{
	...
	public class BabyGoodApiary : CompanionItem
	{
		//Add Snowballs and Sunglasses synergy
		public static void Init()
		{
			string name = "Baby Good Apiary";
			string resourcePath = "CakeMod/Resources/BabyGoodApiary";
			GameObject gameObject = new GameObject();
			var penguin = gameObject.AddComponent<BabyGoodApiary>();

			ItemBuilder.AddSpriteToObject(name, resourcePath, gameObject);

			string shortDesc = "Honey, Bee Nice";
			string longDesc = "A strange enchanted apiary with runes scribbled on the inside.\n" +
				"There are no actual bees inside.";
			ItemBuilder.SetupItem(penguin, shortDesc, longDesc, "cak");
			penguin.quality = PickupObject.ItemQuality.B;
			penguin.CompanionGuid = BabyGoodApiary.guid;
			penguin.Synergies = new CompanionTransformSynergy[0];
			BabyGoodApiary.BuildPrefab();
		}
		...
		public static void BuildPrefab()
		{
			...
			bool flag = BabyGoodApiary.PenguinPrefab != null || CompanionBuilder.companionDictionary.ContainsKey(BabyGoodApiary.guid);
			bool flag2 = flag;
			if (!flag2)
			{
				BabyGoodApiary.PenguinPrefab = CompanionBuilder.BuildPrefab("Baby Good Chamber", BabyGoodApiary.guid, BabyGoodApiary.spritePaths[0], new IntVector2(1, 0), new IntVector2(7, 12));
				BabyGoodApiary.PenguinBehavior penguinBehavior = BabyGoodApiary.PenguinPrefab.AddComponent<BabyGoodApiary.PenguinBehavior>();
				...
				bool flag3 = BabyGoodApiary.beeCollection == null;
				if (flag3)
				{
					BabyGoodApiary.beeCollection = SpriteBuilder.ConstructCollection(BabyGoodApiary.PenguinPrefab, "Ice_Collection");
					UnityEngine.Object.DontDestroyOnLoad(BabyGoodApiary.beeCollection);
					for (int i = 0; i < BabyGoodApiary.spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(BabyGoodApiary.spritePaths[i], BabyGoodApiary.beeCollection);
					}
					SpriteBuilder.AddAnimation(penguinBehavior.spriteAnimator, BabyGoodApiary.beeCollection, new List<int>
					{
						0,
						1
				...
				behaviorSpeculator.AttackBehaviors.Add(new BabyGoodApiary.PenguinAttackBehavior());
				behaviorSpeculator.MovementBehaviors.Add(new BabyGoodApiary.ApproachEnemiesBehavior());
				...
				UnityEngine.Object.DontDestroyOnLoad(BabyGoodApiary.PenguinPrefab);
				FakePrefab.MarkAsFakePrefab(BabyGoodApiary.PenguinPrefab);
				BabyGoodApiary.PenguinPrefab.SetActive(false);
			}
		}
		...
		public static readonly string guid = "beethingie";
		...
		{
			"CakeMod/Resources/apiary/apiary_left_001",
			"CakeMod/Resources/apiary/apiary_left_002",
			"CakeMod/Resources/apiary/apiary_right_001",
			"CakeMod/Resources/apiary/apiary_right_002"
		};

		// Token: 0x04000019 RID: 25
		private static tk2dSpriteCollectionData beeCollection;
		...
		public class PenguinAttackBehavior : AttackBehaviorBase
		{
			...
			public override void Init(GameObject gameObject, AIActor aiActor, AIShooter aiShooter)
			{
				...
				this.Owner = this.m_aiActor.GetComponent<BabyGoodApiary.PenguinBehavior>().Owner;
			}
						...
						if (flag4)
						{
							...
							if (flag5)
							{
								...
								if (flag7)
								{
									...
									component.baseData.damage = 1.5f;
