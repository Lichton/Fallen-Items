...
namespace CakeMod
{
	public class Waterbulon : AIActor
	{
		private void SetGoopIndex(int index)
		{
			this.goopIndex = index;
			this.currentGoop = Waterbulon.goopDefs[index];
			this.tint = Waterbulon.tints[index];
		}
		...
		private static string[] goops = new string[]
	   {
		...
		public static void Init()
		{
			...
			Waterbulon.goopDefs = new List<GoopDefinition>();
			foreach (string text in Waterbulon.goops)
			{
				...
				Waterbulon.goopDefs.Add(goopDefinition);
			}
			GoopDefinition item;
			item = null;
			List<GoopDefinition> goopDefs = Waterbulon.goopDefs;
			goopDefs.Add(item);
			Waterbulon.goopDefs = new List<GoopDefinition>();
			foreach (string text in Waterbulon.goops)
			{
