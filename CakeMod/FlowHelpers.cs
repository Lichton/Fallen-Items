...
namespace CakeMod
{
	class FlowHelpers
	{
		...
		public static DungeonFlow DuplicateDungeonFlow(DungeonFlow flow)
		{
			...
			Toolbox.ReflectionHelpers.ReflectSetField(typeof(DungeonFlow), "m_firstNodeGuid", Toolbox.ReflectionHelpers.ReflectGetField<string>(typeof(DungeonFlow), "m_firstNodeGuid", flow), dungeonFlow);
			dungeonFlow.flowInjectionData = flow.flowInjectionData;
			dungeonFlow.sharedInjectionData = flow.sharedInjectionData;
			Toolbox.ReflectionHelpers.ReflectSetField(typeof(DungeonFlow), "m_nodeGuids", new List<string>(Toolbox.ReflectionHelpers.ReflectGetField<List<string>>(typeof(DungeonFlow), "m_nodeGuids", flow)), dungeonFlow);
			List<DungeonFlowNode> list = new List<DungeonFlowNode>();
			Toolbox.ReflectionHelpers.ReflectSetField(typeof(DungeonFlow), "m_nodes", list, dungeonFlow);
