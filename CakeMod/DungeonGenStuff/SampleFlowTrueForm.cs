...
{
    public static class SampleFlowTrueForm
    {
        public static DungeonFlow CreateDebugFlow(Dungeon dungeon)
        {
            ...
            DungeonFlowNode
                customRoom,
                hub = new DungeonFlowNode(flow) { overrideExactRoom = RoomFactoryTrueForm.CreateEmptyRoom() },
                lastNode = hub;
        ...
        public static DungeonFlow CreateMazeFlow(Dungeon dungeon)
        {
            ...
            flow.FirstNode = entrance;
            flow.AddNodeToFlow(entrance, null);
            var maze = new DungeonFlowNode(flow) { overrideExactRoom = RoomFactoryTrueForm.BuildFromResource("resource/rooms/maze.room").room };
