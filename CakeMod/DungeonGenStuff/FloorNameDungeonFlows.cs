...
namespace CakeMod
{
    class FloorNameDungeonFlows
    {
        ...
        public static SharedInjectionData CathedralInjectionData;

        public static ProceduralFlowModifierData BossBishopRoom;
       ...
       public static PrototypeDungeonRoom dungeonRoom = RoomFactory2.BuildFromResource2("CakeMod/Resources/ModRooms/BishopRoom.room");
        ...
        public bool InjectHim2()
        {
            return InjectHim;
        }
        public bool InjectHim = true;
    }
