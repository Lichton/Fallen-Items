...
namespace CakeMod
{
	...
	public class BabyGoodChamber : CompanionItem
	{
		//Add Snowballs and Sunglasses synergy
		public static void Init()
		{
			string name = "Chamber Friend";
			string resourcePath = "CakeMod/Resources/BabyGoodChamber";
			GameObject gameObject = new GameObject();
			var penguin = gameObject.AddComponent<BabyGoodChamber>();

			ItemBuilder.AddSpriteToObject(name, resourcePath, gameObject);

			string shortDesc = "Chamber";
			string longDesc = "Chamber chamber chamber. Chamber chamber!\n" +
				"Chamber chamber chamber chamber. Chamber. Chamber chamber...";
			ItemBuilder.SetupItem(penguin, shortDesc, longDesc, "cak");
			penguin.quality = PickupObject.ItemQuality.EXCLUDED;
			penguin.CompanionGuid = BabyGoodChamber.guid;
			penguin.Synergies = new CompanionTransformSynergy[0];
			BabyGoodChamber.BuildPrefab();
		}

		// Token: 0x06000060 RID: 96 RVA: 0x0000534D File Offset: 0x0000354D
		public override void Pickup(PlayerController player)
		{
			player.OnRoomClearEvent += BuildBoi;
			base.Pickup(player);
		}

		public static void BuildBoi(PlayerController player)
		{
			...
			public static void BuildPrefab()
		{
			...
			bool flag = BabyGoodChamber.PenguinPrefab != null || CompanionBuilder.companionDictionary.ContainsKey(BabyGoodChamber.guid);
			bool flag2 = flag;
			if (!flag2)
			{
				BabyGoodChamber.PenguinPrefab = CompanionBuilder.BuildPrefab("Baby Good Chamber", BabyGoodChamber.guid, BabyGoodChamber.spritePaths[0], new IntVector2(1, 0), new IntVector2(7, 12));
				BabyGoodChamber.PenguinBehavior penguinBehavior = BabyGoodChamber.PenguinPrefab.AddComponent<BabyGoodChamber.PenguinBehavior>();
				...
				bool flag3 = BabyGoodChamber.iceCollection == null;
				if (flag3)
				{
					BabyGoodChamber.iceCollection = SpriteBuilder.ConstructCollection(BabyGoodChamber.PenguinPrefab, "Ice_Collection");
					UnityEngine.Object.DontDestroyOnLoad(BabyGoodChamber.iceCollection);
					for (int i = 0; i < BabyGoodChamber.spritePaths.Length; i++)
					{
						SpriteBuilder.AddSpriteToCollection(BabyGoodChamber.spritePaths[i], BabyGoodChamber.iceCollection);
					}
					SpriteBuilder.AddAnimation(penguinBehavior.spriteAnimator, BabyGoodChamber.iceCollection, new List<int>
					{
						0,
						1,
						2,
				...
				behaviorSpeculator.AttackBehaviors.Add(new BabyGoodChamber.PenguinAttackBehavior());
				behaviorSpeculator.MovementBehaviors.Add(new BabyGoodChamber.ApproachEnemiesBehavior());
				...
				UnityEngine.Object.DontDestroyOnLoad(BabyGoodChamber.PenguinPrefab);
				FakePrefab.MarkAsFakePrefab(BabyGoodChamber.PenguinPrefab);
				BabyGoodChamber.PenguinPrefab.SetActive(false);
			}
		}
		...
		public static readonly string guid = "chamber";
		...
		{
			"CakeMod/Resources/chamberanim/chamber_001",
			"CakeMod/Resources/chamberanim/chamber_002",
			"CakeMod/Resources/chamberanim/chamber_003",
			"CakeMod/Resources/chamberanim/chamber_004"
		};

		// Token: 0x04000019 RID: 25
		private static tk2dSpriteCollectionData iceCollection;
					...
					if (flag3)
					{
						...
						if (flag4)
						{
							...
							if (flag5)
							{
								...
								Projectile projectile = ((Gun)ETGMod.Databases.Items[482]).DefaultModule.projectiles[0];
