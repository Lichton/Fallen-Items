...
namespace CakeMod
{
	...
	public class OldManBreachInteractable : SimpleInteractable, IPlayerInteractable
	{
		...
		public void Interact(PlayerController interactor)
		{
			...
			if (flag2)
			{
				...
				if (flag4)
				{
					...
					TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "One per person!", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
				}
				else
				{
		...
		private IEnumerator HandleConversation(PlayerController interactor)
		{
			...
			if (flag)
			{
				...
				TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 1f, "Cool.", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
