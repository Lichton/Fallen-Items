...
namespace CakeMod
{
	...
	public class GlowingWomb : CompanionItem
	{
		//Add Snowballs and Sunglasses synergy
		public static void Init()
		{
			string name = "Glowing Womb";
			string resourcePath = "CakeMod/Resources/GlowingWomb";
			GameObject gameObject = new GameObject();
			var womb = gameObject.AddComponent<GlowingWomb>();

			ItemBuilder.AddSpriteToObject(name, resourcePath, gameObject);

			string shortDesc = "Have you no SOUL?";
			string longDesc = "Found deep in Hallownest, this trinket summons minions to fight for you.";
			ItemBuilder.SetupItem(womb, shortDesc, longDesc, "cak");
			womb.quality = PickupObject.ItemQuality.EXCLUDED;
			womb.CompanionGuid = GlowingWomb.guid;
			womb.Synergies = new CompanionTransformSynergy[0];
			GlowingWomb.BuildPrefab();
			GlowingWomb.BuildPrefab();
			GlowingWomb.BuildPrefab();
		}
		...
		public static GameObject WombPrefab;

		// Token: 0x04000017 RID: 23
		public static readonly string guid = "womb";
		...
		{
			"CakeMod/Resources/womb/womb_idle_left_001",
			"CakeMod/Resources/womb/womb_idle_left_002",
			"CakeMod/Resources/womb/womb_idle_right_001",
			"CakeMod/Resources/womb/womb_idle_right_002",
			"CakeMod/Resources/womb/womb_run_left_001",
			"CakeMod/Resources/womb/womb_run_left_002",
			"CakeMod/Resources/womb/womb_run_right_001",
			"CakeMod/Resources/womb/womb_run_right_002"
		};

		// Token: 0x04000019 RID: 25
		private static tk2dSpriteCollectionData wombCollection;

		// Token: 0x02000031 RID: 49
		public class WombBehavior : CompanionController
		{
		...
		public class WombAttackBehavior : AttackBehaviorBase
		{
