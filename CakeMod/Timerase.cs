...
namespace CakeMod
{
    ...
    public class Timerase : GunBehaviour
    {
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            Instantiate<GameObject>(EasyVFXDatabase.SmoothLightBlueLaserCircleVFX, player.unadjustedAimPoint, Quaternion.identity);
        }
        ...
        public override void OnReloadPressed(PlayerController player, Gun gun, bool bSOMETHING)
        {
            if (gun.IsReloading && this.HasReloaded)
            {
                ...
                if (flag4)
                {
                    Instantiate<GameObject>(EasyVFXDatabase.ChestTeleporterTimeWarp, player.CenterPosition, Quaternion.identity);
        ...
        private void OnHitEnemy(Projectile bullet, SpeculativeRigidbody enemy, bool fuckingsomethingidk)
        {
            ...
            if (flag)
            {
                ...
                {
                    Instantiate<GameObject>(EasyVFXDatabase.ChestTeleporterTimeWarp, enemy.UnitCenter, Quaternion.identity);
                    enemy.aiActor.EraseFromExistence(false);
                }
            }
        }
