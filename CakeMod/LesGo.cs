...
namespace CakeMod
{
	...
	public static class LesGo
	{
		...
		public static void Add()
		{
			try
			{
				ShrineFactory ShrineFactory = new ShrineFactory
				{
					...
					OnAccept = new Action<PlayerController, GameObject>(LesGo.Accept),
					OnDecline = null,
					CanUse = new Func<PlayerController, GameObject, bool>(LesGo.CanUse),
				...
				gameObject.AddAnimation("idle", "CakeMod/Resources/LesGo/lesgo_idle", 4, NPCBuilder.AnimationType.Idle, DirectionalAnimation.DirectionType.None, DirectionalAnimation.FlipType.None);
				gameObject.AddAnimation("talk", "CakeMod/Resources/LesGo/lesgo_idle", 4, NPCBuilder.AnimationType.Talk, DirectionalAnimation.DirectionType.None, DirectionalAnimation.FlipType.None);
				gameObject.AddAnimation("talk_start", "CakeMod/Resources/LesGo/lesgo_idle", 4, NPCBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.None, DirectionalAnimation.FlipType.None);
				gameObject.AddAnimation("do_effect", "CakeMod/Resources/LesGo/lesgo_idle", 3, NPCBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.None, DirectionalAnimation.FlipType.None);
		...
		{
			return player != LesGo.storedPlayer;
		}
