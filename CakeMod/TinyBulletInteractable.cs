...
namespace CakeMod
{
	...
	public class TinyBulletInteractable : SimpleInteractable, IPlayerInteractable
	{
		...
		public void Interact(PlayerController interactor)
		{
			...
			if (flag2)
			{
				...
				if (flag4)
				{
					...
					TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "chococake", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
				}
				else
				{
