...
namespace CakeMod
{
    ...
    public class Dupligun : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Dupligun", "timerase");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:dupligun", "cak:dupligun");
            gun.gameObject.AddComponent<Dupligun>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Double Trouble");
            gun.SetLongDescription("Double the gun, double the fun. - The motto of Two-Faced Samuel, dual-wielding gungeoneer.");
            ...
            gun.encounterTrackable.EncounterGuid = "makeyourownfriends";
