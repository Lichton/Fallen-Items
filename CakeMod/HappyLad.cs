...
namespace CakeMod
{
	...
	public class HappyLad : CompanionItem
	{
		//Add Snowballs and Sunglasses synergy
		public static void Init()
		{
			string name = "Happy Lad";
			string resourcePath = "CakeMod/Resources/HappyLad";
			GameObject gameObject = new GameObject();
			var penguin = gameObject.AddComponent<HappyLad>();

			ItemBuilder.AddSpriteToObject(name, resourcePath, gameObject);

			string shortDesc = "I'm Positive";
			string longDesc = "Happiness radiates from this slab of brick.\n" +
				"A yellow carving with a strange smile.";
			ItemBuilder.SetupItem(penguin, shortDesc, longDesc, "cak");
			penguin.quality = PickupObject.ItemQuality.EXCLUDED;
			penguin.CompanionGuid = HappyLad.guid;
			penguin.Synergies = new CompanionTransformSynergy[0];
			HappyLad.BuildPrefab();
		}
		...
		public static readonly string guid = "happyboi";
		...
		{
			"CakeMod/Resources/ahappyguy/happy_left_001",
			"CakeMod/Resources/ahappyguy/happy_left_002",
			"CakeMod/Resources/ahappyguy/happy_right_001",
			"CakeMod/Resources/ahappyguy/happy_right_002"
		};
		...
		public class PenguinAttackBehavior : AttackBehaviorBase
		{
			...
			public override void Init(GameObject gameObject, AIActor aiActor, AIShooter aiShooter)
			{
				...
				this.Owner = this.m_aiActor.GetComponent<HappyLad.PenguinBehavior>().Owner;
			}
