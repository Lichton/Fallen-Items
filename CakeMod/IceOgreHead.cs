...
namespace CakeMod
{
	...
	public class IceOgreHead : CompanionItem
	{
		//Add Snowballs and Sunglasses synergy
		public static void Init()
		{
			string name = "Ice Ogre Head";
			string resourcePath = "CakeMod/Resources/IceOgreHead";
			GameObject gameObject = new GameObject();
			var penguin = gameObject.AddComponent<IceOgreHead>();

			ItemBuilder.AddSpriteToObject(name, resourcePath, gameObject);

			string shortDesc = "SpICEy";
			string longDesc = "Once a malfunctioning gun, a rouge SOURCErer haphazardly transformed it into a companion.";
			ItemBuilder.SetupItem(penguin, shortDesc, longDesc, "cak");
			penguin.quality = PickupObject.ItemQuality.EXCLUDED;
			penguin.CompanionGuid = IceOgreHead.guid;
			penguin.Synergies = new CompanionTransformSynergy[0];
			IceOgreHead.BuildPrefab();
		}
		...
		public static readonly string guid = "ice";
		...
		{
			"CakeMod/Resources/ice/ice_idle_left_001",
			"CakeMod/Resources/ice/ice_idle_left_002",
			"CakeMod/Resources/ice/ice_idle_left_003",
			"CakeMod/Resources/ice/ice_idle_left_004",
			"CakeMod/Resources/ice/ice_idle_right_001",
			"CakeMod/Resources/ice/ice_idle_right_002",
			"CakeMod/Resources/ice/ice_idle_right_003",
			"CakeMod/Resources/ice/ice_idle_right_004",
			"CakeMod/Resources/ice/ice_run_left_001",
			"CakeMod/Resources/ice/ice_run_left_002",
			"CakeMod/Resources/ice/ice_run_left_003",
			"CakeMod/Resources/ice/ice_run_left_004",
			"CakeMod/Resources/ice/ice_run_left_005",
			"CakeMod/Resources/ice/ice_run_left_006",
			"CakeMod/Resources/ice/ice_run_left_007",
			"CakeMod/Resources/ice/ice_run_right_001",
			"CakeMod/Resources/ice/ice_run_right_002",
			"CakeMod/Resources/ice/ice_run_right_003",
			"CakeMod/Resources/ice/ice_run_right_004",
			"CakeMod/Resources/ice/ice_run_right_005",
			"CakeMod/Resources/ice/ice_run_right_006",
			"CakeMod/Resources/ice/ice_run_right_007"
		};
						...
						if (flag4)
						{
							...
							if (flag5)
							{
								...
								if (flag7)
								{
									...
									if (Owner.HasPickupID(387) || Owner.HasPickupID(130))
									{
