...
namespace CakeMod
{
    class PocketRedChest : PlayerItem
    {
        //Call this method from the Start() method of your ETGModule extension class
        public static void Init()
        {
            //The name of the item
            string itemName = "Pocket Red Chest";

            //Refers to an embedded png in the project. Make sure to embed your resources! Google it.
            string resourceName = "CakeMod/Resources/PocketRedChest";

            //Create new GameObject
            GameObject obj = new GameObject(itemName);

            //Add a ActiveItem component to the object
            var item = obj.AddComponent<PocketRedChest>();

            //Adds a tk2dSprite component to the object and adds your texture to the item sprite collection
            ItemBuilder.AddSpriteToObject(itemName, resourceName, obj);

            //Ammonomicon entry variables
            string shortDesc = "A Tier";
            string longDesc = "A miniturized version of the classic Red Chest, it dispenses a clone of itself on use.";
            ...
            CakeIDs.PocketRedChest= item.PickupObjectId;
        }
