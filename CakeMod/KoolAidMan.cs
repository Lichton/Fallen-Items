...
namespace CakeMod
{
	public class KoolAidMan : AIActor
	{
		...
		public static readonly string guid = "KMan";
		...
		public static void BuildPrefab()
		{
			...
			if (prefab == null || !EnemyBuilder.Dictionary.ContainsKey(guid))
			{
				...
				prefab.AddAnimation("idle_left", "CakeMod/Resources/KoolAidMan", fps: 7, AnimationType.Idle, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("idle_right", "CakeMod/Resources/KoolAidMan", fps: 7, AnimationType.Idle, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("run_left", "CakeMod/Resources/KoolAidMan", fps: 7, AnimationType.Move, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("run_right", "CakeMod/Resources/KoolAidMan", fps: 7, AnimationType.Move, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("pitfall", "CakeMod/Resources/KoolAidMan", fps: 7, AnimationType.Idle, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once);
				...
				prefab.AddAnimation("attack_left", "CakeMod/Resources/KoolAidMan", fps: 8, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				prefab.AddAnimation("attack_right", "CakeMod/Resources/KoolAidMan", fps: 8, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				prefab.AddAnimation("die_left", "CakeMod/Resources/KoolAidMan", fps: 12, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				prefab.AddAnimation("die_right", "CakeMod/Resources/KoolAidMan", fps: 12, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				...
				shootpoint = new GameObject("kmancenter");
				shootpoint.transform.parent = enemy.transform;
				shootpoint.transform.position = enemy.sprite.WorldCenter;
				GameObject position = enemy.transform.Find("kmancenter").gameObject;
				...
				bs.MovementBehaviors = new List<MovementBehaviorBase>
			{
				...
				Game.Enemies.Add("cak:kman", enemy.aiActor);
			}
		}
