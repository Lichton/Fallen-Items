...
namespace CakeMod
{
	public class DemonGuy : AIActor
	{
		...
		public static readonly string guid = "greeddemon";
		public static void Init()
		{
			//As always don't forget to initalize your enemy. 
			DemonGuy.BuildPrefab();
		}
		...
		public class DemonGuyScript : Script
		{
			...
			protected override IEnumerator Top()
			{
				...
				yield return this.Wait(10);//Here the script will wait 6 frames before firing another shot.
				yield break;
			}
		}
		...
		public class BasicBullet : Bullet
		{
			...
			public BasicBullet() : base("bigBullet", false, false, false)
			{
			}
