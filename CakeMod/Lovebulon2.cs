...
namespace CakeMod
{
	public class Loverblob : AIActor
	{
		...
		public static readonly string guid = "loverblob";
		...
		public static void BuildPrefab()
		{
			...
			{
				//Sets up the prefab of the enemy. The spritepath, "FrostAndGunfireItems/Resources/Loverblob/Idle/milton_idle_001", determines the setup sprite for your enemy. vvvv This bool right here determines whether or not an enemy has an AiShooter or not. AIShooters are necessary if you want your enemy to hold a gun for example. An example of this can be seen in Humphrey.
				prefab = EnemyBuilder.BuildPrefab("Loverblob", guid, "CakeMod/Resources/Lovebulon/Idle/lovebulon_idle_001", new IntVector2(0, 0), new IntVector2(0, 0), false);
				...
				prefab.AddAnimation("idle_left", "CakeMod/Resources/Lovebulon/Idle", fps: 5, AnimationType.Idle, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("idle_right", "CakeMod/Resources/Lovebulon/Idle", fps: 5, AnimationType.Idle, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("run_left", "CakeMod/Resources/Lovebulon/Idle", fps: 5, AnimationType.Move, DirectionType.TwoWayHorizontal);
				prefab.AddAnimation("run_right", "CakeMod/Resources/Lovebulon/Idle", fps: 5, AnimationType.Move, DirectionType.TwoWayHorizontal);
				...
				prefab.AddAnimation("attack_left", "CakeMod/Resources/Lovebulon/Idle", fps: 8, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				prefab.AddAnimation("attack_right", "CakeMod/Resources/Lovebulon/Idle", fps: 8, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				prefab.AddAnimation("die_left", "CakeMod/Resources/Lovebulon/Idle", fps: 8, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				prefab.AddAnimation("die_right", "CakeMod/Resources/Lovebulon/Idle", fps: 8, AnimationType.Move, DirectionType.TwoWayHorizontal, tk2dSpriteAnimationClip.WrapMode.Once, assignAnimation: false);
				...
				shootpoint = new GameObject("lover center");
				shootpoint.transform.parent = enemy.transform;
				shootpoint.transform.position = enemy.sprite.WorldCenter;
				GameObject position = enemy.transform.Find("lover center").gameObject;
				...
				bs.TargetBehaviors = new List<TargetBehaviorBase>
			{
				...
				new ShootBehavior() {
					...
					BulletScript = new CustomBulletScriptSelector(typeof(LoverblobScript)),
					LeadAmount = 0f,
					AttackCooldown = 4f,
				...
				bs.MovementBehaviors = new List<MovementBehaviorBase>
			{
				...
				Game.Enemies.Add("cak:loverblob", enemy.aiActor);
			}
		}
		...
		public class LoverblobScript : Script
		{
			...
			protected override IEnumerator Top()
			{
				...
				for (int i = 0; i < 2; i++)
				{
					...
					base.Fire(new Direction(i * 40, Brave.BulletScript.DirectionType.Aim, -1f), new Speed(4f, SpeedType.Absolute), new LoverblobBullet());
					yield return this.Wait(6);//Here the script will wait 6 frames before firing another shot.
				}
				yield break;
			}
		}
		public class LoverblobBullet : Bullet
		{
			//la bullet
			public LoverblobBullet() : base("default", false, false, false)
			{
			}
